...
// - FList (Fast List) should be used if you need an array where you are using almost every index
//   such as the position system or graphics system. It uses up a lot of space but has instant indexing
//   (unless it must resize)
...
namespace wj
{
    ...
    public:
        ...
        void operator= (const FList &other) = delete;
...
#endif /* end of include guard: __FLIST_H__ */
